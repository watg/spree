...
WATG.signup = {
	...
	getPromo: function() {
		return '<p>Thanks for signing up.<br/>Enter code when you check out to get 15% off your order* :)<br/><strong>HELLO72X76</strong><br/><small>*Expires midnight 26th September</small></p>';
	},
