...
WATG.signup = {
	...
	getPromo: function() {
		return '<p>Thanks for signing up.<br/>Enter code when you check out to get 15% off your order* :)<br/><strong>HELLO72X76</strong><br/><small>*Expires midnight 19th September</small></p>';
	},
...
WATG.referral = {
	...
	showThanks: function() {
		...
		$('<p class="thanks">Thanks for signing up! <br/>Your patterns are on their way <br/><br/> <a href="/shop/knitwear/knitting/wool-and-cotton">Don\'t forget to get your yarn!</a> </p>' ).hide().insertBefore(this.referralForm).fadeIn('slow').focus();
