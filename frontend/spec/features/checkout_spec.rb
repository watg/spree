...
#       xit "does not break the per-item shipping method calculator", :js => true do
#         add_mug_to_cart
#         click_button "Checkout"
...
#       xit "displays confirmation step", :js => true do
#         add_mug_to_cart
#         click_button "Checkout"
...
#       order.stub(:available_payment_methods => [ create(:check_payment_method, :environment => 'test') ])
...
#     let(:credit_cart_payment) {create(:check_payment_method, :environment => 'test') }
...
#       xit "redirects user back to address step" do
#         visit spree.checkout_state_path("payment")
#         expect(current_path).to eql(spree.checkout_state_path("address"))
#       end

#       xit "updates shipments properly through step address -> delivery transitions" do
#         visit spree.checkout_state_path("payment")
#         click_on "Save and Continue"
#         click_on "Save and Continue"
...
#     xit "makes sure payment reflects order total with discounts" do
...
#       xit "doesnt create a payment record" do
