...
RSpec.describe Spree::ShipmentHandler do
  ...
  describe "#perform" do
    context "#when the courier provides their own shipment email" do
      before { shipment.carrier = "WNINT" }
      it "does not sends a shipment confirmation email" do
    ...
    context "when the courier does not not contact the client" do
      it "sends a shipment confirmation email" do
        shipment.send_email = true
