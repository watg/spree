...
describe Spree::AddParcelToOrderService do
  ...
  context "#run" do
    ...
    let(:small_box) { FactoryGirl.create(:product, product_type: :product, individual_sale: false, product_group_id: box_group.id, weight: 5.0, depth: 30.0, width: 34.0, height: 20.0) }
