...
describe Api::Dashboard::Warehouse::FormatTodayOrdersByPriority, type: :interaction do
  let(:express_orders) { build_stubbed_list(:order, 3, state: "complete") }
  let(:regular_orders) { build_stubbed_list(:order, 7, state: "complete") }
