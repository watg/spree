  ...
  module Api
    module Dashboard
      ...
      class WarehouseController < Spree::Api::BaseController
        def today_orders
          today_orders = Spree::Api::Dashboard::Warehouse::FormatTodayOrders
                         .new(Spree::Order.complete).run
          render json: today_orders.to_json
        end

        def today_sells_by_marketing_type
          today_orders = Spree::Api::Dashboard::Warehouse::FormatTodaySellsByType
                         .new(Spree::Order.complete).run
          render json: today_orders.to_json
        end
        ...
        def printed_orders
          p_orders = Spree::Api::Dashboard::Warehouse::FormatPrintedOrders
                     .new(Spree::Order.complete).run
          render json: p_orders.to_json
        end

        def printed_by_marketing_type
          p_orders = Spree::Api::Dashboard::Warehouse::FormatPrintedItemsByType
                     .new(Spree::Order.complete).run
          render json: p_orders.to_json
        end

        def unprinted_orders
          unp_orders = Spree::Api::Dashboard::Warehouse::FormatUnprintedOrders
                       .new(Spree::Order.complete).run
          render json: unp_orders.to_json
        end

        def unprinted_by_marketing_type
          unp_orders = Spree::Api::Dashboard::Warehouse::FormatUnprintedItemsByType
                       .new(Spree::Order.complete).run
          render json: unp_orders.to_json
        end

        def unprinted_orders_waiting_feed
          wf_orders = Spree::Api::Dashboard::Warehouse::FormatWaitingFeedOrders
                      .new(Spree::Order.complete).run
          render json: wf_orders.to_json
        end

        def waiting_feed_by_marketing_type
          wf_orders = Spree::Api::Dashboard::Warehouse::FormatWaitingFeedByType
                      .new(Spree::Order.complete).run
          render json: wf_orders.to_json
        end
